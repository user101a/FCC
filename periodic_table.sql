...
--
-- Name: elements unq_ele; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unq_ele UNIQUE (name);


--
-- Name: elements unq_sym; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unq_sym UNIQUE (symbol);


--
-- Name: properties fk_atomic_numbers; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_atomic_numbers FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
